...
export const Auth: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 font-sans flex flex-col items-center justify-center p-4">
                ...
                <div className="relative bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
                    ...
                    <div className="mt-6 text-center">
                        <button
                            ...
                            className="text-sm text-teal-500 dark:text-teal-400 hover:underline"
                        >
